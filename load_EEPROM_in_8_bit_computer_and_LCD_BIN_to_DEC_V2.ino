...
byte data[255]; // we dont need to ddeclare an array like this when we load from a .txt file { 0x0f, 0x0a, 0x17, 0x0a, 0x1f, 0x00, 0xe2, 0x38, 0x0b, 0x03, 0x2d, 0xcf, 0x2f, 0x06};
...
void setup() {
  ...
  int i = 0;
  Serial.begin(9600); //this baudrate must be the same in the Proccesing sketch
...
void loop() {
  ...
  a6 = highOrLow(6, 0b10);
  a7 = highOrLow(7, 0b1);
  byte b = a0 | a1 | a2 | a3 | a4 | a5 | a6 | a7;
